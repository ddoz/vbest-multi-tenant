...
@section('content')
				<div class="col-sm-12">
                    ...
                    <div class="alert alert-success alertstatus">
                        ...
                        <form action="{{route('master-jenis-kepemilikan.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Nama Jenis Kepemilikan</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control @error('nama_jenis') is-invalid @enderror" value="{{old('nama_jenis')}}" placeholder="Jenis Izin Kepemilikan" name="nama_jenis">
