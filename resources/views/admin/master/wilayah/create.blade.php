...
@section('content')
				<div class="col-sm-12">
                    ...
                    <div class="alert alert-success alertstatus">
                        ...
                        <form action="{{route('master-wilayah.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                        @if($tab=='')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control @error('provinsi') is-invalid @enderror" value="{{old('provinsi')}}" placeholder="Nama Provinsi" name="provinsi">
                        ...
                        @if($tab=='kabupaten')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control @error('kabupaten') is-invalid @enderror" value="{{old('kabupaten')}}" placeholder="Nama Kabupaten" name="kabupaten">
                        ...
                        @if($tab=='kecamatan')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control @error('kecamatan') is-invalid @enderror" value="{{old('kecamatan')}}" placeholder="Nama Kecamatan" name="kecamatan" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="kabupaten_id" id="kabupaten_id" class="form-control select2" required>
                                        ...
                                        <option value="{{$kb->id}}">{{$kb->kabupaten}} (Provinsi: {{$kb->provinsi->provinsi}})</option>
                                        @endforeach
                                    </select>
                        ...
                        @if($tab=='kelurahan')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control @error('kelurahan') is-invalid @enderror" value="{{old('kelurahan')}}" placeholder="Nama Kelurahan" name="kelurahan" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="kecamatan_id" id="kecamatan_id" class="form-control select2" required>
                                        ...
                                        <option value="{{$kb->id}}">{{$kb->kecamatan}}  (Provinsi: {{$kb->kabupaten->provinsi->provinsi}}. Kabupaten: {{$kb->kabupaten->kabupaten}})</option>
                                        @endforeach
                                    </select>
