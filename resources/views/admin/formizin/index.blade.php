					...
					<div class="card card-wrapper">
						<div class="card-header">
                            <div class="d-flex flex-row justify-content-between">
								<div>
                                    <a href="{{route('verifikasi.izin',$vendor->id)}}" class="btn btn-outline-warning btn-xs">
                                        <i class="ti ti-angle-left"></i>
                                    </a> Verifikasi Izin
                                    @if($izin->status_dokumen=='VERIFIED')
						...
						<div class="card-body">
                            ...
                            @if($izin->status_dokumen=="VERIFIED" && $izin->verified_id!=null)           
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$kui->kualifikasi_bidang->nama_kualifikasi}}</td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
                        ...
                        <div class="card-footer">
                            <form onsubmit="return confirm('Ubah Status Dokumen?')" action="{{route('izin.state',$izin->id)}}" method="POST">
                                @csrf
...
<script type="text/javascript">
  $(function () {
    var table = $('#verifyDatatables').DataTable({
			...
			serverSide: true,
			stateSave: true,
			ajax: "{{ route('verifikasi.formizin', ['vendor'=>$vendor->id,'izin'=>$izin->id]) }}",
			columns: [
