					...
					<div class="card card-wrapper">
						<div class="card-header">
                            <div class="d-flex flex-row justify-content-between">
								<div>
                                    <a href="{{route('verifikasi.neraca',$vendor->id)}}" class="btn btn-outline-warning btn-xs">
                                        <i class="ti ti-angle-left"></i>
                                    </a> Verifikasi Neraca
                                    @if($neraca->status_dokumen=='VERIFIED')
						...
						<div class="card-body">
                            ...
                            @if($neraca->status_dokumen=="VERIFIED" && $neraca->verified_id!=null)           
                        ...
                        <div class="card-footer">
                            <form onsubmit="return confirm('Ubah Status Dokumen?')" action="{{route('neraca.state',$neraca->id)}}" method="POST">
                                @csrf
...
<script type="text/javascript">
  $(function () {
    var table = $('#verifyDatatables').DataTable({
			...
			serverSide: true,
			stateSave: true,
			ajax: "{{ route('verifikasi.formneraca', ['vendor'=>$vendor->id,'neraca'=>$neraca->id]) }}",
			columns: [
