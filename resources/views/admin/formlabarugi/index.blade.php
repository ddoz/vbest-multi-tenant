					...
					<div class="card card-wrapper">
						<div class="card-header">
                            <div class="d-flex flex-row justify-content-between">
								<div>
                                    <a href="{{route('verifikasi.laba-rugi',$vendor->id)}}" class="btn btn-outline-warning btn-xs">
                                        <i class="ti ti-angle-left"></i>
                                    </a> Verifikasi Laba Rugi
                                    @if($laba_rugi->status_dokumen=='VERIFIED')
						...
						<div class="card-body">
                            ...
                            @if($laba_rugi->status_dokumen=="VERIFIED" && $laba_rugi->verified_id!=null)           
                        ...
                        <div class="card-footer">
                            <form onsubmit="return confirm('Ubah Status Dokumen?')" action="{{route('laba-rugi.state',$laba_rugi->id)}}" method="POST">
                                @csrf
...
<script type="text/javascript">
  $(function () {
    var table = $('#verifyDatatables').DataTable({
			...
			serverSide: true,
			stateSave: true,
			ajax: "{{ route('verifikasi.formlabarugi', ['vendor'=>$vendor->id,'laba_rugi'=>$laba_rugi->id]) }}",
			columns: [
