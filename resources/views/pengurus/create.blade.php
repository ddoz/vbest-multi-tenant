            ...
            <div class="card-body">
                ...
                <form action="{{route('pengurus.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="jenis_kepengurusan_id" class="form-control @error('jenis_kepengurusan_id') is-invalid @enderror select2">
                                <option value="">Pilih Jenis Kepengurusan</option>
                                @foreach($jenisKepengurusan as $jk)
                                    <option @if(old('jenis_kepengurusan_id')==$jk->id) selected @endif value="{{$jk->id}}">{{$jk->nama}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="jabatan" value="{{old('jabatan')}}" placeholder="Jabatan" class="form-control @error('jabatan') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" value="{{old('menjabat_sejak')}}" name="menjabat_sejak" class="form-control datepicker @error('menjabat_sejak') is-invalid @enderror">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" value="{{old('menjabat_sampai')}}" name="menjabat_sampai" class="form-control datepicker @error('menjabat_sampai') is-invalid @enderror">
