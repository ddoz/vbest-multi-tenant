    ...
    <div class="col-sm-10">
        <div class="card card-wrapper">
            <div class="card-header">
                ...
                Form Edit Laporan Keuangan - Neraca
            </div>
            <div class="card-body">  
                ...
                @endif                
                <form action="{{route('neraca.update', $neraca->id)}}" method="POST">
                    @csrf
                    @method("PUT")
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="tahun" required class="form-control select2 @error('tahun') is-invalid @enderror">
                                ...
                                <option @if($neraca->tahun==$y) echo selected @endif value="{{$y}}">{{$y}}</option>
                                @php }@endphp
                            </select>
                            @if ($errors->has('tahun'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$neraca->aset}}" placeholder="Aset" name="aset" required class="form-control @error('aset') is-invalid @enderror">
                            @if ($errors->has('aset'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$neraca->kewajiban}}" placeholder="Kewajiban" name="kewajiban" required class="form-control @error('kewajiban') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$neraca->modal}}" placeholder="Modal" name="modal" required class="form-control @error('modal') is-invalid @enderror">
                            @if ($errors->has('modal'))
