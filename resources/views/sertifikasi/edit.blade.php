            ...
            <div class="card-body">
                ...
                <form action="{{route('sertifikasi.update', $sertifikasi->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="jenis_sertifikat" required value="{{$sertifikasi->jenis_sertifikat}}" class="form-control @error('jenis_sertifikat') is-invalid @enderror">
                                <option value="">Pilih Jenis Sertifikat</option>
                                <option @if($sertifikasi->jenis_sertifikat=='ISO') selected @endif value="ISO">ISO</option>
                                <option @if($sertifikasi->jenis_sertifikat=='SMK3') selected @endif value="SMK3">SMK3</option>
                                <option @if($sertifikasi->jenis_sertifikat=='Lainnya') selected @endif value="Lainnya">Lainnya</option>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="nomor" value="{{$sertifikasi->nomor}}" required class="form-control @error('nomor') is-invalid @enderror" placeholder="Nomor">
                            @if ($errors->has('nomor'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select name="seumur_hidup" required class="form-control @error('seumur_hidup') is-invalid @enderror">
                                <option @if($sertifikasi->seumur_hidup=='Tidak') selected @endif value="Tidak">Tidak</option>
                                <option @if($sertifikasi->seumur_hidup=='Ya') selected @endif value="Ya">Ya</option>
                            </select>
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" name="berlaku_sampai" value="{{$sertifikasi->berlaku_sampai}}" class="form-control datepicker @error('berlaku_sampai') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$sertifikasi->instansi_pemberi}}" name="instansi_pemberi" required class="form-control @error('instansi_pemberi') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="keterangan_tambahan" cols="2" rows="3" class="form-control @error('keterangan_tambahan') is-invalid @enderror">{{$sertifikasi->keterangan_tambahan}}</textarea>
