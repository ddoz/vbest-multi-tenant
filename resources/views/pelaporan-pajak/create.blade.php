    ...
    <div class="col-sm-10">
        <div class="card card-wrapper">
            ...
            <div class="card-body">                
                ...
                @endif
                <form action="{{route('pelaporan-pajak.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="jenis_pelaporan" id="" class="form-control @error('jenis_pelaporan') is-invalid @enderror select2" required>
                                ...
                                <option @if(old('jenis_pelaporan')=='SPT Tahunan') selected @endif value="SPT Tahunan">SPT Tahunan</option>
                                <option @if(old('jenis_pelaporan')=='SPT Masa PPH 21') selected @endif value="SPT Masa PPH 21">SPT Masa PPH 21</option>
                                <option @if(old('jenis_pelaporan')=='SPT Masa PPH 25/29') selected @endif value="SPT Masa PPH 25/29">SPT Masa PPH 25/29</option>
                                <option @if(old('jenis_pelaporan')=='SPT Masa PPH 23') selected @endif value="SPT Masa PPH 23">SPT Masa PPH 23</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="masa_tahun_pajak" required class="form-control select2 @error('masa_tahun_pajak') is-invalid @enderror">
                                ...
                                <option @if(old('masa_tahun_pajak')==$y) echo selected @endif value="{{$y}}">{{$y}}</option>
                                @php }@endphp
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="nomor_bukti_surat" required value="{{old('nomor_bukti_surat')}}" class="form-control @error('nomor_bukti_surat') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="tanggal_bukti_surat" value="{{old('tanggal_bukti_surat')}}" required placeholder="Tanggal Bukti Penerimaan Surat" class="form-control @error('tanggal_bukti_surat') is-invalid @enderror datepicker">
