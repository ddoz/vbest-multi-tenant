						...
						<div class="card-body">	
							...
							<form action="{{route('pengalaman.store')}}" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<textarea name="nama_kontrak" required cols="30" rows="3" placeholder="Nama Kontrak" class="form-control @error('nama_kontrak') is-invalid @enderror">{{old('nama_kontrak')}}</textarea>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<textarea name="lingkup_pekerjaan" required cols="30" rows="10" placeholder="Lingkup Pekerjaan" class="form-control @error('lingkup_pekerjaan') is-invalid @enderror">{{old('lingkup_pekerjaan')}}</textarea>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<input type="text" name="nomor_kontrak" value="{{old('nomor_kontrak')}}" placeholder="Nomor Kontrak" required class="form-control @error('nomor_kontrak') is-invalid @enderror">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<select name="kategori_pekerjaan_id" class="form-control @error('kategori_pekerjaan_id') is-invalid @enderror select2" required>
											...
											<option @if(old('kategori_pekerjaan_id')==$kp->id) echo selected @endif value="{{$kp->id}}">{{$kp->nama_kategori}}</option>
											@endforeach
										</select>
								...
								<div class="form-group row">
									...
									<div class="col-sm-3">
										...
										<input type="text" name="pelaksanaan_kontrak" value="{{old('pelaksanaan_kontrak')}}" placeholder="Pelaksanaan Kontrak" required class="form-control datepicker @error('pelaksanaan_kontrak') is-invalid @enderror">
									...
									<div class="col-sm-3">
										...
										<input type="text" name="selesai_kontrak" value="{{old('selesai_kontrak')}}" placeholder="Selesai Kontrak" required class="form-control datepicker @error('selesai_kontrak') is-invalid @enderror">
								...
								<div class="form-group row">
									...
									<div class="col-sm-3">
										...
										<input type="text" name="serah_terima_pekerjaan" value="{{old('serah_terima_pekerjaan')}}" required placeholder="Serah Terima Pekerjaan" class="form-control datepicker @error('serah_terima_pekerjaan') is-invalid @enderror">
									...
									<div class="col-sm-3">
										...
										<input type="text" name="nilai_kontrak" value="{{old('nilai_kontrak')}}" placeholder="Nilai Kontrak" class="form-control @error('nilai_kontrak') is-invalid @enderror">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<input type="text" value="{{old('presentase_pekerjaan')}}" value="{{old('presentase_pekerjaan')}}" name="presentase_pekerjaan" placeholder="Presentase Pekerjaan" required class="form-control @error('presentase_pekerjaan') is-invalid @enderror">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<input type="text" value="{{old('tanggal_progress')}}" placeholder="Tanggal Input Progress" name="tanggal_progress" required class="form-control datepicker @error('tanggal_progress') is-invalid @enderror">
								...
								<div class="">
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<textarea class="form-control @error('nama_alamat_proyek') is-invalid @enderror" name="nama_alamat_proyek" required placeholder="Nama Proyek/Alamat Proyek">{{old('nama_alamat_proyek')}}</textarea>
										...
										<div class="col-sm-3">
											...
											<select name="lokasi_pekerjaan_provinsi_id" id="lokasi_pekerjaan_provinsi_id" class="form-control @error('lokasi_pekerjaan_provinsi_id') is-invalid @enderror select2" required>
												...
												@foreach($provinsi as $p) 
													<option @if(old('lokasi_pekerjaan_provinsi_id')==$p->id) selected @endif value="{{$p->id}}">{{$p->provinsi}}</option>
												@endforeach
											</select>
								...
								<div class="">
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<textarea placeholder="Instansi Pengguna Barang/Jasa" class="form-control @error('instansi_pengguna') is-invalid @enderror" required name="instansi_pengguna">{{old('instansi_pengguna')}}</textarea>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<textarea class="form-control" name="alamat_instansi" required placeholder="Alamat Instansi">{{old('alamat_instansi')}}</textarea>
									...
									<div class="form-group row">
										...
										<div class="col-sm-3">
											...
											<select name="instansi_provinsi_id" id="instansi_provinsi_id" class="form-control @error('instansi_provinsi_id') is-invalid @enderror select2" required>
												<option value="">Pilih Provinsi</option>
												@foreach($provinsi as $p) 
													<option @if(old('instansi_provinsi_id')==$p->id) selected @endif value="{{$p->id}}">{{$p->provinsi}}</option>
												@endforeach
											</select>
										...
										<div class="col-sm-3">
											<label for="">Kabupaten/Kota</label>
											<select name="instansi_kabupaten_id" id="instansi_kabupaten_id" class="form-control @error('instansi_kabupaten_id') is-invalid @enderror select2"></select>
									...
									<div class="form-group row">
										...
										<div class="col-sm-3">
											<label for="">Kecamatan</label>
											<select name="instansi_kecamatan_id" id="instansi_kecamatan_id" required class="form-control @error('instansi_kecamatan_id') is-invalid @enderror select2"></select>
										...
										<div class="col-sm-3">
											<label for="">Kelurahan</label>
											<select name="instansi_kelurahan_id" id="instansi_kelurahan_id" required class="form-control @error('instansi_kelurahan_id') is-invalid @enderror select2"></select>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" value="{{old('telpon_instansi')}}" name="telpon_instansi" placeholder="Telpon Instansi" required class="form-control @error('telpon_instansi') is-invalid @enderror">
