    ...
    <div class="col-sm-10">
        <div class="card card-wrapper">
            <div class="card-header">
                ...
                Form Edit Laporan Keuangan - Laba-Rugi                
            </div>
            <div class="card-body"> 
                ...
                <form action="{{route('laba-rugi.update',$laba_rugi->id)}}" method="POST">
                    @csrf
                    @method("PUT")
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="tahun" required class="form-control select2 @error('tahun') is-invalid @enderror">
                                ...
                                <option @if($laba_rugi->tahun==$y) echo selected @endif value="{{$y}}">{{$y}}</option>
                                @php }@endphp
                            </select>
                            @if ($errors->has('tahun'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$laba_rugi->pendapatan}}" placeholder="Pendapatan" name="pendapatan" required class="form-control @error('pendapatan') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$laba_rugi->laba_kotor}}" placeholder="Laba Kotor" name="laba_kotor" required class="form-control @error('laba_kotor') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$laba_rugi->laba_bersih}}" placeholder="Laba Bersih" name="laba_bersih" required class="form-control @error('laba_bersih') is-invalid @enderror">
