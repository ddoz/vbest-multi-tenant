            ...
            <div class="card-body">
                ...
                <form action="{{route('pemilik.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="jenis_kepemilikan_id" required class="form-control @error('jenis_kepemilikan_id') is-invalid @enderror select2">
                                <option value="">Pilih Jenis Kepemilikan</option>
                                @foreach($jenisKepemilikan as $jk) 
                                    <option @if(old('jenis_kepemilikan_id')==$jk->id) selected @endif value="{{$jk->id}}">{{$jk->nama_jenis}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="nama" required value="{{old('nama')}}" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama">
                            @if ($errors->has('nama'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="kewarganegaraan_id" id="" class="form-control @error('kewarganegaraan_id') is-invalid @enderror select2" required>
                                <option value="">Pilih Kewarganegaraan</option>
                                @foreach($kewarganegaraan as $k) 
                                    <option @if(old('kewarganegaraan_id')==$k->id) selected @endif value="{{$k->id}}">{{$k->nama_kewarganegaraan}}</option>
                                @endforeach
                            </select>
                            @if ($errors->has('nama'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" placeholder="KTP / Nomor Paspor" value="{{old('nomor_identitas')}}" name="nomor_identitas" required class="form-control @error('nomor_identitas') is-invalid @enderror">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" name="npwp" value="{{old('npwp')}}" placeholder="NPWP" class="form-control @error('npwp') is-invalid @enderror">
                            @if ($errors->has('npwp'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="alamat" required cols="2" rows="3" class="form-control @error('alamat') is-invalid @enderror">{{old('alamat')}}</textarea>
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <input type="text" name="jumlah_saham" required value="{{old('jumlah_saham')}}" class="form-control  @error('jumlah_saham') is-invalid @enderror form-control-sm" autocomplete="off" onkeyup="NumberOnly(this)">
                                </div>
                                <div class="input-group-append">
                                    <select name="jenis_saham" class="form-control @error('jenis_saham') is-invalid @enderror form-control-sm">
                                        <option @if(old('jenis_saham')=='Persen') selected @endif value="Persen">Persen</option>
                                        <option @if(old('jenis_saham')=='Lembar') selected @endif value="Lembar">Lembar</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="keterangan_tambahan" id="" cols="2" rows="3" class="form-control @error('keterangan_tambahan') is-invalid @enderror">{{old('keterangan_tambahan')}}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="userfile" accept=".jpg,.jpeg,.png,.bmp,.pdf" name="scan_dokumen" required>
