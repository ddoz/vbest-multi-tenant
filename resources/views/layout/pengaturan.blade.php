						...
						<div class="card bg-sidebar">
							<div class="card-body">
								<ul class="navbar-nav mr-auto">									
									...
									<li class="nav-item">
										<a class="nav-link {{ (request()->segment(1) == 'pengaturan' && request()->segment(2) == '') ? 'active' : '' }}" href="{{route('pengaturan.index')}}"><i class="ti ti-list"></i> Pengaturan Menu</a>
									</li>
									<li class="nav-item">
										<a class="nav-link {{ (request()->segment(1) == 'pengaturan-site') ? 'active' : '' }}" href="{{route('pengaturan-site.index')}}"><i class="ti ti-info-alt"></i> Pengaturan Website</a>
									</li>									
